...
const AppStateFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_appstate_free(ptr >>> 0));
/**
*/
export class AppState {
    ...
    */
    static new(w, h) {
        const ret = wasm.appstate_new(w, h);
    ...
    */
    on_mousedown(button) {
        wasm.appstate_on_mousedown(this.__wbg_ptr, button);
    }
    /**
    * @param {number} button
    */
    on_mouseup(button) {
        wasm.appstate_on_mouseup(this.__wbg_ptr, button);
    }
    /**
    * @param {number} x
    * @param {number} y
    */
    on_mousemove(x, y) {
        wasm.appstate_on_mousemove(this.__wbg_ptr, x, y);
    }
    /**
    ...
    */
    tick(canvas_ctx) {
        try {
            wasm.appstate_tick(this.__wbg_ptr, addBorrowedObject(canvas_ctx));
        } finally {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('quark_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
